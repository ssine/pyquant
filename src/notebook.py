...
#%%
plt.plot(xs, df['i9888_price'].values - df['rb888_price'].values)

#%%
lp = df['i9888_price'].values
xs = range(len(lp))

fig = plt.figure()
ax = fig.add_subplot(111)

ax.plot(xs, lp, label='i', color='orange')

ax2 = ax.twinx()
ax2.plot(xs, df['rb888_price'].values, label='rb')
